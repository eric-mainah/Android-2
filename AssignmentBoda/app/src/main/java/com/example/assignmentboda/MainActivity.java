 ...
 /*   fname=findViewById(R.id.textFirstname);
    ...
    saveBtn=findViewById(R.id.button);
        ...
        public void onClick(View v) {
            ...
            String Message = "Your name is "+Firstname+" "+Lastname+".";
            ...
            if(Firstname.isEmpty()){
                ...
                Intent display = new Intent(MainActivity.this ,displayPage.class );
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        // automatically handle clicks on the hpage/Up button, so long
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            Intent hpage= new Intent(MainActivity.this , displayPage.class);
            startActivity(hpage);
